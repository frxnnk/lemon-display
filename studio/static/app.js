import { CARD_TEMPLATES, clampCard, drawScreen, newCard } from "./screen_renderer.js?v=studio-web-2";
import { createWorkbench3D } from "./workbench3d.js?v=studio-web-2";
...
const STATIC_STUDIO = location.pathname.startsWith("/studio/") || !["127.0.0.1", "localhost"].includes(location.hostname);
...
function boot() {
  ...
  drawScreen(state.screenCanvas, fallbackManifest(), "");
